/*
 * TODO: �뚭퀬�덈뒗 �꾩튂���꾩슂�뚯씪��遺덈윭�ㅺ쾶��留뚮뱾硫��대젃寃�紐곗븘�ｌ� �딆븘���좏뀗��
 * 
 *  $$namespace
 *     - �좊떦 �꾩튂
 *       : window.$$namespace  
 *     - ��븷
 *       : path, moduleManager, moduleLoader, Module, namespace���명꽣�섏씠��
 *   
 *  @parmas
 *    - this : �꾩옱 �섏씠吏�쓽 window
 *    
 */
(function () {
	var parentModule = {}; // 媛�紐⑤뱢��李몄“瑜���옣�섎뒗 蹂�닔.
	...
	//�대쫫���대뼸寃�諛붽�源� �쒕쾭���붿껌�����덈뒗 紐⑤뱢�대쫫.(dir, 紐⑤뱢�대쫫, �뺤옣���ы븿�쒓쾬)
	...
	path.getModulePathAndEqualCountOne = function (modulePath, modulePathOfPackage) {
		var partsOfmodulePath = this.getRevesedPartsOfPath(modulePath, '/')
		  , partsOfmodulePathOfPackage = this.getRevesedPartsOfPath(modulePathOfPackage, '/') //�깅뒫�μ긽 �꾪빐 罹먯돩媛�뒫.
		...
		for(var i = 0, max = minLength; i < max; ++i) {
			...
			if(partOfmodulePath === partOfmodulePathOfPackage)
				...
				break; //�ㅻⅤ硫�踰붿쐞瑜�踰쀬뼱�쒓굅���ㅼ쓬寃껊퉬援먯븞�대킄���쒕떎.
		}
	...
	function isExtension(modulePath, extensionName) { // .js   .遺숈뿬�쇳븿
...
(function() {
	...
	moduleManager.moduleMap  = {}; //蹂듭옟�댁�硫�由ы뙆吏�꽣由щ줈 遺꾨━�좎닔��.
//	moduleManager.cachedModuleMap = {}; //�좎궗 紐⑤뱢�⑥뒪���ㅼ젣 紐⑤뱢�⑥뒪瑜�諛붿씤�⑹떆耳쒖꽌 罹먯떆媛�뒫.
	...
	moduleManager.saveModuleOne = function (similaireModulePath, status, loadedModule) {
		...
		if(isNotExist(module) || isExist(loadedModule)) {
			...
			moduleMap[modulePath].setStatus(status); //媛숈� 紐⑤뱢��李몄“�섎땲源�罹먯돩 status蹂�꼍�덊빐�꾨릺寃잛�?
		}
	}
	...
	// 以묐났�섏� �딆� �대쫫���섎룄濡앹� namespace�먯꽌 嫄몃윭�⑥쓬.
...
(function() {
	...
	// 鍮꾨룞湲곗쟻�쇰줈 紐⑤몢 濡쒕뵫�섍퀬 �꾨즺��endDone�몄텧.
	...
	/*
	 * 鍮꾨룞湲�濡쒕뱶 ���ㅽ겕由쏀듃媛��먮룞 �ㅽ뻾�쒕떎.
	 * ����$$namespace.include(method) 瑜��ㅽ뻾�섍쾶 �섏뿬 �ㅽ뻾��紐⑤뱢��李몄“瑜��꾩떆��옣�쒕떎.
	 * �뺤긽 �꾨즺 ��getScirpt��肄쒕갚�⑥닔媛��ㅽ뻾�쒕떎.
	 *   
	 */
...
//		console.log(filePath)
	...
	//this濡�module��媛뽯뒗�� // Module���꾩튂�쒖폒���좉쾬媛숈���.
	namespace.require = function (modulePath) {
